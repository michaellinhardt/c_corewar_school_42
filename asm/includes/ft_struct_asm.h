...
/*
enum	e_value {NO_VALUE, MINI_NAME, CMD_NAME, MINI_COMMENT, CMD_COMMENT,
				HEADER,
...
enum	e_value	{NO_VALUE, MINI_NAME, CMD_NAME, MINI_COMMENT, CMD_COMMENT,
	HEADER, ARG, INST, FIN_LINE, LAST_ARG, CPL_INST, POSITION, POSITION_INST,
	VIRGULE, CODE_FIN, FIN};
