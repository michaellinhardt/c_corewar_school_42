...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/11 13:20:43 by abary             #+#    #+#             */
/*   Updated: 2016/11/11 13:20:43 by abary            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_check_name_instructions(char *instructions,
		t_instructions *inst);
...
int				ft_compile_direct(t_parse_tree *tree,
		unsigned char *code, int flag_dir);
int				ft_compile_direct_label(t_parse_tree *tree,
		unsigned char *code, int flag_dir);
int				ft_compile_indirect(t_parse_tree *tree,
		unsigned char *code);
