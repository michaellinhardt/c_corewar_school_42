...
void	ft_init_parser(t_parser *parser)
{
	...
	parser->f_shift[13] = ft_shift_end;
	...
	parser->f_accept[4] = ft_accept_end_inst;
	parser->f_accept[5] = ft_accept_label;
	parser->f_accept[6] = ft_accept_end_inst;
	parser->f_accept[7] = ft_accept_comment;
	parser->f_accept[8] = ft_accept_name;
	parser->f_accept[9] = ft_accept_header;
	parser->f_accept[10] = ft_accept_code_header;
}
